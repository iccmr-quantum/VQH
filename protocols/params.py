...
class ParamsProtocol:
    ...
    def decode(self, data):
        ...
        params = data[0][0].tolist()
        #print('Params Here:', params)
        #variables_index = data[1]
        #loudnesses = self.params_to_loudness(params, variables_index)
        #loudness_list_of_dicts = self.loudnesses_to_list_of_dicts(loudnesses)
        return params
